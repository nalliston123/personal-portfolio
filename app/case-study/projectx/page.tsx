...
export default function ProjectXCaseStudy() {
  const caseStudy = {
    ...
    <div className={`${quicksand.variable} font-sans relative`}>
      ...
      <div className="mx-auto max-w-4xl px-4 py-12 md:px-6 lg:py-16 relative min-h-screen z-10">
        ...
        <section className="mb-12">
          ...
          <p className="mb-4">I trained a custom OpenAI assistant on my CV, a personality index assesment and a Q&A document about me. I built the frontend using v0 and the questions are stored in a NEON Postgres datatbase. Analytics and deployments are all managed in Vercel.</p>
        </section>
