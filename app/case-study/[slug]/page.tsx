...
export default function CaseStudy({ params }: { params: { slug: string } }) {
  ...
  return (
    <div className={`${quicksand.variable} font-sans relative`}>
      <NeuralBackground />
      <div className="mx-auto max-w-4xl px-4 py-12 md:px-6 lg:py-16 relative min-h-screen z-10">
        ...
        <section className="mb-12">
          ...
          <p className="mb-4">
            One of the worst parts is having a list that isn't organized in the same way that a store is. So you end up going back and forth up and down different aisles finding your items, which makes shopping inefficient and time consuming.
          </p>
          <Image 
            ...
            alt="A focused shopper consulting a digital device while navigating a grocery store aisle, illustrating the need for better shopping list organization" 
            width={1200} 
            height={675} 
        ...
        <section className="mb-12">
          ...
          <Image 
            ...
            alt="Sortee app interface showing three screens: list creation with suggestions, organized categories, and list sharing functionality" 
            width={1200} 
            height={600} 
